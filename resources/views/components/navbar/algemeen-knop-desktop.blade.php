...
<div x-data="{ open: false }" @mouseenter="open = true" @mouseleave="open = false" class="relative group cursor-pointer">
    <!-- Button -->
    <div
        class="bg-jnn-logo-bl-l flex w-full lg:w-max items-stretch h-12 p-1 pr-2 border-transparent border-2 rounded-sm shadow-[4px_4px_0_0] shadow-[#0008] cursor-pointer lg:rotate-2 group-hover:rotate-0 group-hover:bg-white group-hover:border-jnn-logo-zw transition-all">
