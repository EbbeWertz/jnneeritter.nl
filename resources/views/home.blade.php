<x-layout.public>
    <div id="banner" class="bg-jnn-logo-bl overflow-hidden flex flex-col items-center">
        ...
        {{-- CTA Lint --}}
        <div
        class="flex justify-between w-full items-center bg-black/30 -mb-4 px-8 pt-2 pb-6 animate-slide-right-3">
            {{-- Welkom & actions --}}
        ...
        {{-- <i-scheidlijno class="text-jnn-paper-p w-[2048px] min-w-screen mt-0.5 -mb-0.5 z-30"></i-scheidlijno> --}}
    </div>
aaaaaaaaaa
<br>
aaaaaaaaaa
